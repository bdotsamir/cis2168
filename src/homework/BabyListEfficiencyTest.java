...
public class BabyListEfficiencyTest {
  public static void main(String[] args) {
    ...
    int n = 400_000; // number of elements in the list // CHANGE THIS NUMBER TO RUN OTHER TESTS
  ...
  public static <E> void testGetNoIterator(BabyList<E> list, int numOfTests) {
    double average;
  ...
  public static <E> void testIteratorNext(BabyList<E> list, int numOfTests) {
    double average;
    long start = System.currentTimeMillis();
    int element; // the current list element
    String[] anim = {" |", " /", " -", " \\"};  // to do something in constant time (rotating bar)
